...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Feb 2020 pada 19.26
...
(1, 'IN001', 'Senin', '07:00', '09:00', 'Free', 'Aktif'),
(2, 'IN001', 'Selasa', '08:30', '09:30', 'Free', 'Aktif'),
(3, 'IN001', 'Rabu', '09:30', '09:45', 'Free', 'Aktif'),
(4, 'IN001', 'Kamis', '07:00', '07:00', 'Free', 'Aktif');
...
--
ALTER TABLE `detail_bs`
  MODIFY `id_detail_bs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
