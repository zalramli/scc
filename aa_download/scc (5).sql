...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Feb 2020 pada 23.55
...
(7, 'IN001', 'Senin', '12:00', '13:00', 'Free', 'Aktif', '2020-02-05'),
...
--
ALTER TABLE `detail_prove`
  MODIFY `id_detail_prove` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
