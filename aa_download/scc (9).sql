...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Mar 2020 pada 02.59
...
('BS200224-002', 'EK002', 3, '2020-02-24', '2020-02-26', 'Batal');
...
(8, 'IN001', 'Selasa', '07:00', '09:00', 'Unfree', 'Aktif', '2020-02-29'),
...
('200229-002', 'EK001', 6, 8, 'wjjw', '2020-02-29', '2020-03-03', '200229-002', 'G6YMw', 'Belum Selesai');
...
--
ALTER TABLE `detail_absensi`
  MODIFY `id_detail_absensi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
