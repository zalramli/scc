...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Mar 2020 pada 16.23
...
INSERT INTO `bank_software` (`kode_bank_s`, `id_eksternal`, `id_jadwal_bs`, `tanggal_booking`, `tanggal_bs`, `status_bs`, `rating`) VALUES
('BS200221-001', 'EK001', 2, '2020-02-21', '2020-02-20', 'Batal', 0),
('BS200221-002', 'EK001', 3, '2020-02-21', '2020-02-22', 'Selesai', 1),
('BS200221-003', 'EK001', 2, '2020-02-21', '2020-02-25', 'Selesai', 4),
('BS200221-006', 'EK002', 1, '2020-02-21', '2020-02-23', 'Batal', 0),
('BS200224-001', 'EK001', 1, '2020-02-24', '2020-02-23', 'Batal', 0),
('BS200224-002', 'EK002', 3, '2020-02-24', '2020-02-26', 'Batal', 0),
('BS200308-001', 'EK001', 2, '2020-03-08', '2020-03-17', 'Belum Selesai', 3);
...
(1, '200219-001', 'EK001', 1, ''),
(2, '200229-001', 'EK001', 5, ''),
(3, '200229-001', 'EK002', 0, ''),
(4, '200229-002', 'EK001', 5, ''),
(5, '200229-002', 'EK002', 0, '');
...
('IN007', 'Ichwanul Kahfi Prasetya', '082335791531', 'kosong', 'bb', 'b', 'Staff', 'PR', 'Junior', 'IN007'),
...
(1, 'IN001', 'Senin', '07:00', '09:00', 'Free', 'Aktif', '2020-02-29'),
...
(7, 'IN001', 'Senin', '12:00', '13:00', 'Free', 'Aktif', '2020-02-19'),
(8, 'IN001', 'Selasa', '07:00', '09:00', 'Free', 'Aktif', '2020-02-29'),
(9, 'IN001', 'Rabu', '07:00', '09:00', 'Free', 'Aktif', '2020-02-06');

-- --------------------------------------------------------

--
-- Stand-in struktur untuk tampilan `list_anggota_absensi`
...
('200219-001', 'EK001', 6, 7, 'ekekek', '2020-02-19', '2020-02-24', '200219-001', 'k4npQ', 'Selesai'),
('200229-001', 'EK001', 6, 1, 'skksk', '2020-02-29', '2020-03-02', '200229-001', 'BqhwH', 'Selesai'),
('200229-002', 'EK001', 6, 8, 'wjjw', '2020-02-29', '2020-03-03', '200229-002', 'G6YMw', 'Selesai');
...
--
-- Struktur untuk view `list_anggota_absensi`
--
...
--
ALTER TABLE `detail_absensi`
  MODIFY `id_detail_absensi` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `detail_bs`
--
ALTER TABLE `detail_bs`
  MODIFY `id_detail_bs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT untuk tabel `detail_prove`
--
ALTER TABLE `detail_prove`
  MODIFY `id_detail_prove` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
